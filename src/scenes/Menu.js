...
var Menu = /** @class */ (function (_super) {
    ...
    Menu.prototype.create = function () {
        ...
        var controls_text = this.add.sprite(0, game.screen_height, 'ui-controls').setOrigin(0, 1).setScale(0.5);
        var credits_text = this.add.sprite(game.screen_width, game.screen_height, 'ui-credits').setOrigin(1, 1).setScale(0.5);
        // Bind key inputs
        game.setScene(this);
